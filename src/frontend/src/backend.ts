...
import type { LanguageSettings as _LanguageSettings, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, VocabularyItem as _VocabularyItem } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addVocabularyItem(arg0: string, arg1: string, arg2: string | null, arg3: Array<string> | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addVocabularyItem(arg0, arg1, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVocabularyItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteVocabularyItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllVocabularyItems(): Promise<Array<VocabularyItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVocabularyItems();
    ...
    async getItemsDueForReview(): Promise<Array<VocabularyItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemsDueForReview();
                return from_candid_vec_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeUser(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPracticeResult(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPracticeResult(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_VocabularyItem_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VocabularyItem): VocabularyItem {
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    practiceCounter: bigint;
    activeLanguage: _LanguageSettings;
    vocabulary: Array<_VocabularyItem>;
}): {
    practiceCounter: bigint;
    activeLanguage: LanguageSettings;
    vocabulary: Array<VocabularyItem>;
    ...
    return {
        practiceCounter: value.practiceCounter,
        activeLanguage: value.activeLanguage,
        vocabulary: from_candid_vec_n5(_uploadFile, _downloadFile, value.vocabulary)
    };
}
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        tags: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.tags)),
        word: value.word,
        ...
        lastSeen: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.lastSeen))
    };
}
...
function from_candid_vec_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VocabularyItem>): Array<VocabularyItem> {
    return value.map((x)=>from_candid_VocabularyItem_n6(_uploadFile, _downloadFile, x));
}
...
function to_candid_VocabularyItem_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VocabularyItem): _VocabularyItem {
...
function to_candid_opt_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<string> | null): [] | [Array<string>] {
    return value === null ? candid_none() : candid_some(value);
}
function to_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        practiceCounter: value.practiceCounter,
        activeLanguage: value.activeLanguage,
        vocabulary: to_candid_vec_n18(_uploadFile, _downloadFile, value.vocabulary)
    };
}
...
function to_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<VocabularyItem>): Array<_VocabularyItem> {
    return value.map((x)=>to_candid_VocabularyItem_n19(_uploadFile, _downloadFile, x));
}
